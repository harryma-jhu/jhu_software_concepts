...
SYSTEM_PROMPT = (
    ...
    "names.\n\n"
    "Rules:\n"
    "- You will receive a JSON object with 'program' and 'university' fields.\n"
    "- Extract and standardize the program name and university name.\n"
...
def _call_llm(program_text: str, university_text: str) -> Dict[str, str]:
    ...
    input_data = {"program": program_text, "university": university_text}
    messages.append(
...
def standardize() -> Any:
    ...
    for row in rows:
        ...
        university_text = row.get("university","")
...
def _cli_process_file(
    ...
    try:
        for row in rows:
            ...
            result = _call_llm(raw_program, raw_university)
            row["llm-generated-program"] = result["standardized_program"]
            row["llm-generated-university"] = result["standardized_university"]
