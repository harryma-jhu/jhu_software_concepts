...
def load_data():
    ...
    with connection.cursor() as cur:
        ...
        with open('src/data/llm_extend_applicant_data_liv.json', 'r', encoding='utf-8') as f:
            data = json.load(f)
            for record in data:
                ...
                """
                params = (           
                    prgm, record.get('university'),record.get('comments'), record.get('date_added'),
